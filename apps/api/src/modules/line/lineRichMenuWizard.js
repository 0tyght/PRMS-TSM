...
const STATIC_SUBMENUS = Object.freeze({
  ...
  status: {
    ...
    choices: [
      ...
      choice("แจ้งย้ายออก", "action=status_pick_MOVED_OUT"),
      choice("โอนเจ้าของ", "action=transfer_select"),
    ],
  },
  requests: {
    key: "submenu-requests-v12",
    title: "ข้อมูลที่ฉันส่ง",
    ...
    choices: [
      ...
      choice("ข้อมูลทั้งหมด", "action=requests_all"),
...
export function buildMainWizardDefinition(state) {
  if (!state?.linked) {
    return {
      ...
      choices: [
        ...
        choice("ติดตามข้อมูล", "action=track"),
  ...
  return {
    ...
    choices: [
      ...
      staticSwitchChoice("ข้อมูลที่ส่ง", "requests"),
