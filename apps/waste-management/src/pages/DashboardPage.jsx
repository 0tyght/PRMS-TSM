  ...
  return <>
    ...
    {loading ? <LoadingState /> : <>
      ...
      <section className="waste-readiness" aria-label="ความพร้อมในการวางแผนงาน">
        ...
        <button type="button" className={routesWithoutGeometry ? "is-warning" : ""} onClick={() => navigate("resources")}><span>เส้นทางยังไม่มีแนวถนน</span><strong>{formatNumber(routesWithoutGeometry)}</strong><small>กำหนดเส้นทางบนแผนที่</small></button>
      </section>
