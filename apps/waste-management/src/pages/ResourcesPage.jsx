  ...
  return (
    <form className="waste-form" onSubmit={submit}>
      ...
      {type === "routes" && <>
        ...
        <label>สถานะ<select name="isActive" defaultValue={String(initial?.isActive ?? true)}><option value="true">เยกเลิกการใช้งาน</option><option value="false">ยกเลิกการใช้งาน</option></select></label>
