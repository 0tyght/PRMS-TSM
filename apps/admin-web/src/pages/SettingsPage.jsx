...
export default function SettingsPage({ token }) {
  ...
  return (
    <>
      ...
      <MfaSettingsCard api={api} onError={setMessage} />
      <section className="settings-grid core-system-grid">
        ...
        <article className="panel"><i className="setting-icon line">L</i><div><b>LINE OA / LIFF</b><span>ช่องทางหลักสำหรับเจ้าของสัตว์เลี้ยง</span></div><em className={system?.line === "configured" ? "ready" : "waiting"}>{system?.line === "configured" ? "ตั้งค่าแล้ว" : "รอการตั้งค่า"}</em></article>
